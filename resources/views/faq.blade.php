...
<x-layout.main>
    ...
    <section class="question">
        <details>
            ...
            Go to <a href="https://hz.mynetpay.nl" target="_blank">hz.mynetpay.nl</a> and select "Mobility Print".
        ...
        <details>
            ...
            Log in to a printer using your HZ student card or username and password. Select the "scan" option and
        ...
        <details>
            ...
            Go to <a href="https://webshop.hz.nl" target="_blank">webshop.hz.nl</a> and use the navigation bar to select
        ...
        <details>
            ...
            Log into MyHZ and select the selfservice portal in the personal menu. Select "Reservations", then "Reserve a
        ...
        <details>
            ...
            It is not possible to park at the Groene Woud campus. The parking lot on Kousteensedijk has a number of
